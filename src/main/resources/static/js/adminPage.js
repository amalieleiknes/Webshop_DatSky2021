...
$(function(){
    ...
    function formatProductData(products){
        let table="<table class='table table-condensed'>" +
            "<thead><tr><th>Name</th><th>Short Description</th><th>Long Description</th><th>Price</th>" +
        ...
        $.each(products, function( key, product) {
            table+="<tr><td><input type='text' readonly id='productID"+line+"' size='10' value='"+product.productID+"'/></td>" +
                ...
                "<td><input type='text' readonly id='image"+line+"' size=12 value='"+product.image+"'/></td>" +
